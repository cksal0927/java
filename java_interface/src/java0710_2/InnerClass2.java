...
class BankAccount{
	...
	private static String bankName = "찬미Bank";
	public BankAccount(int balance) {  // 생성자 메서드
		this.balance = balance;
	}
	
	public void showBalance() {  // 계좌 확인 메서드
...
public class InnerClass2 {
	...
	public static void main(String[] args) {
		...
		// 정적 내부 클래스 객체 생성
		BankAccount.BankInfo into = new BankAccount.BankInfo();
		info.showBankName();
...
/*
	...
	BankAccount 내부클래스 ->
		...
		지역 내부 클래스 : Loan (대출)
		익명 내부 클래스 : Runnable (이자 계산, 익명 클래스 이름 아니고 인터페이스 이름)
*/